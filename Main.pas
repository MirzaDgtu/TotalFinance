            ...
            Begin
              ...
              if (AppData.Users.FieldByName('Admin').AsString <> '*') and (AppData.CorrExpenceDoc.FieldByName('OTMETKA').AsString = '*') then
                  ...
                  Begin
                      ...
                      ExpenseForm.Caption := 'Корректировка документа';
                      ExpenseForm.NumDocEdit.Text := ReestrExpenseOther.FieldByName('NUMDOC').AsString;
                      ExpenseForm.ExpencePicker.Date := ReestrExpenseOther.FieldByName('DATE_P_POR').AsDateTime;
                      ExpenseForm.PrimechEdit.Text := ReestrExpenseOther.FieldByName('PRIMECH').AsString;
                      ExpenseForm.MonthCombo.Visible := False;
                      ExpenseForm.YearSpinEdit.Visible := False;
                      ExpenseForm.ExpenseStringGrid.RowCount := RecordCountExpenceDetail;
...
begin
   ...
   if not (ReestrExpenseOther.IsEmpty) then
    Begin
       Appdata.CorrExpenceDoc.Active := False;
       Appdata.CorrExpenceDoc.CommandText := EmptyStr;
       Appdata.CorrExpenceDoc.CommandText := Format(SSQLGetExpenceDetail, [MainForm.ReestrExpenseOther.FieldByName('UNICUM_NUM').AsInteger]);
       Appdata.CorrExpenceDoc.Active := True;
...
begin
      ...
      ZpAupForm.ZpAupStringGridSetting(g_CreateDoc);
        ...
        Begin
              ...
              if (AppData.Users.FieldByName('Admin').AsString <> '*') and (AppData.ZpAupDetail.FieldByName('OTMETKA').AsString = '*') then
                  ...
                  Begin
                      ...
                      ZpAupForm.ZpAupStringGridSetting(g_CorrDoc);
                      ...
                      Begin
                       for i:= 1 to ZpAupForm.ZpAupStringGrid.RowCount-1 do
                        Begin
                           with ZpAupForm.ZpAupStringGrid  do
                            begin
...
begin
  ...
  if not (ReestrZpAup.IsEmpty) then
      Begin
            ZpAupForm.ZpAupStringGridSetting(g_Preview);
    ...
    Begin
            ...
            Sum_Not_Nal := 0;
             ...
             RecordCountExpenceDetail := AppData.ExpenceDetail.RecordCount+1;
                 ...
                 ExpenseForm.NumDocEdit.Text := ReestrExpense.FieldByName('NUMDOC').AsString;
                 ExpenseForm.ExpencePicker.Date := ReestrExpense.FieldByName('DATE_P_POR').AsDateTime;
                 ExpenseForm.PrimechEdit.Text := ReestrExpense.FieldByName('PRIMECH').AsString;
                 ExpenseForm.MonthCombo.Visible := False;
                 ExpenseForm.YearSpinEdit.Visible := False;
                 ExpenseForm.ExpenseStringGrid.RowCount := RecordCountExpenceDetail;
...
begin
  ...
  TaxToZpForm.SettingTaxToZp(g_CreateDoc);
        ...
        Begin
           ...
           if (AppData.Users.FieldByName('Admin').AsString <> '*') and (AppData.GetTaxToZpDetail.FieldByName('OTMETKA').AsString = '*') then
              ...
              Begin
                  ...
                  TaxToZpForm.SettingTaxToZp(g_CorrDoc);
                  ...
                  Begin
                   for i:= 1 to TaxToZpForm.TaxZpStringGrid.RowCount-1 do
                    Begin
                       with TaxToZpForm.TaxZpStringGrid do
                        begin
 ...
 if not (ReestrTaxToZp.IsEmpty) then
    Begin
            ...
            AppData.GetTaxToZpDetail.Active := True;
               ...
               Sum_Not_Nal := 0;
              TaxToZpForm.SettingTaxToZp(g_Preview);
...
begin
  ...
  PercentOfTerminalForm.SettingPercentOfTerminal(g_CreateDoc);
...
begin
    ...
    if not (ReestrPercentOfTerminal.IsEmpty) then
        Begin
            ...
            Sum_Not_Nal := 0;
            PercentOfTerminalForm.SettingPercentOfTerminal(g_Preview);
...
begin
    ...
    ShipmentForm.SettingShipmentForm(TAB_ShipmentVostok, g_CreateDoc);
          ...
          Begin
              ...
              if (AppData.Users.FieldByName('Admin').AsString <> '*') and (AppData.ShipmentDetail.FieldByName('OTMETKA').AsString = '*') then
                  ...
                  Begin
                    ...
                    TypeShipment := TAB_ShipmentVostok;
                    ShipmentForm.SettingShipmentForm(TAB_ShipmentVostok, g_CorrDoc);
...
begin
  with TTypeEnergyForm.Create(Application) do
    Begin
        try
          ShowModal();
        except
          FreeAndNil(TypeEnergyForm);
        end;
    end;
...
begin
   with TStateBuhForm.Create(Application) do
    Begin
      try
         ShowModal();
      except
         FreeAndNil(StateBuhForm);
      end;
    end;    
end;
...
begin
  with TDownloadFileForm.Create(Application) do
    Begin
      try
          ShowModal();
      except
         FreeAndNil(DownloadFileForm);
      end;
    end;
end;
