      ...
      if not (ReestrShipmentVostok.IsEmpty) then
          Begin
              ...
              AppData.ShipmentDetail.Active := True;
                  ...
                  ShipmentF.SettingShipmentForm(TAB_ShipmentVostok, g_Preview);
...
begin
  ...
  try
        ...
        ShipmentF.SettingShipmentForm(TAB_ShipmentOther, g_CreateDoc);
                  ...
                  Begin
                      ...
                      if (AppData.Users.FieldByName('Admin').AsString <> '*') and (AppData.ShipmentDetail.FieldByName('OTMETKA').AsString = '*') then
                          ...
                          Begin
                            TypeSaveShipment := g_CorrDoc;
                            TypeShipment := TAB_ShipmentOther;
                            ShipmentF.SettingShipmentForm(TAB_ShipmentOther, g_CorrDoc);
       ...
       if not (ReestrShipmentOther.IsEmpty) then
          Begin
              ...
              AppData.ShipmentDetail.Active := True;
                  ...
                  TypeSaveShipment := g_Preview;
                  ShipmentF.SettingShipmentForm(TAB_ShipmentOther, g_Preview);
                  Sum_Nal     := 0;
                  Sum_Not_Nal := 0;
...
var
    ...
    OffsF: TOffsForm;
begin
    OffsF := TOffsForm.Create(MainForm);
    ...
    try
          ...
          OffsF.SettingOffsForm(TAB_Offs, g_CreateDoc);

        AppData.Organiz.First;
         with OffsF.OffsStringGrid do
          Begin
            RowCount := AppData.Organiz.RecordCount+1;
            while not AppData.Organiz.Eof do
             Begin
   ...
   try
       if not (ReestrOffs.IsEmpty) then
         Begin
            ...
            OffsF.SettingOffsForm(TAB_Offs, g_CorrDoc);
                      ...
                      Begin
                        ...
                        DecodeDate(ReestrOffs.FieldByName('DATE_P_POR').AsDateTime, Year, Month, Day);
                         ...
                         with OffsF do
                          ...
                          OffsF.OffsStringGrid.Cells[0,0] := '№';
                          AppData.GetDetailOffs.First;
                          while not  AppData.GetDetailOffs.Eof do
                          Begin
                            for i:= 1 to OffsF.OffsStringGrid.RowCount -1 do
                            Begin
                              OffsF.OffsStringGrid.Cells[0,i] := IntToStr(i);
                             with OffsF.OffsStringGrid  do
                              begin
    ...
    try
        if not (ReestrOffs.IsEmpty) then
            Begin
              ...
              OffsF.SettingOffsForm(TAB_Offs, g_Preview);
